...
$string['onedrivelink'] = 'OneDrive link jksadfklhjfsdkf hsdfjklhaf fkhjsdk jfhsdjk skajdhas dkfhsdkjf sdfjk';
...
$string['tooluse_upload_text'] = 'As an alternative to completing the template above, upload a completed {$a} into the field below.';
