...
$string['onedrivelink'] = 'OneDrive link';
...
$string['supportingevidence_text1'] = 'Upload screenshots, drafts, version history, and other supporting materials required or recommended by your course coordinator.';
...
$string['tooluse_method_label'] = 'Method';
$string['tooluse_method_required'] = 'Please choose how you will provide tool use details.';
$string['tooluse_method_text_helper'] = 'Describe each tool you used directly. Use this option if you have just text to provide.';
$string['tooluse_method_text_title'] = 'Enter text';
$string['tooluse_method_upload_helper'] = 'Upload one or more files describing each tool you used. Use this option if you have screenshots, annotated documents, or other non-text materials to provide as evidence of your tool use.';
